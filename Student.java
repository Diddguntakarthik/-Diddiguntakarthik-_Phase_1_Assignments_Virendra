...
public class Student {
	    ...
	    public Student(String string, int i, char c, char d, int j, int k, int l) {
	    ...
	    public static void main(String[] args) {
	        ...
	        Student s1 = new Student("karthik", 21, 'A','F', 77,79,89);
	        Student s2 = new Student("vani", 26, 'B','F', 0,56,65);
